                        ...
                        <div className="container" style={{border: '2px solid #b11917', height: '80vh', width: '80%', background:'white'}}>
                            ...
                            <div className="row mt-1 text-justify">
                                ...
                                <Dropdown isOpen={dropdownOpen} toggle={toggle}>
                                    ...
                                    <DropdownMenu right>
                                        <DropdownItem header className="font-weight-bold"><FilterListIcon  style={{ color: '#b11017' }}/> Filter Received Orders by:</DropdownItem>
                                        <DropdownItem divider/>
                                        <DropdownItem onClick={() => handleFilter('new_received') } className={switchSent, switchReceived}><ReceiptIcon className="mr-3" />Newly Received</DropdownItem>
                                        <DropdownItem divider/>
                                        <DropdownItem onClick={() => handleFilter('delivered') }><DoneIcon className="mr-3"/>Delivered</DropdownItem>
                                        <DropdownItem divider/>
                                        <DropdownItem onClick={() => handleFilter('processing') }><CachedIcon className="mr-3" />Processing</DropdownItem>
                                        <DropdownItem divider/>
                                        <DropdownItem onClick={() => handleFilter('declined')}><NotInterestedIcon className="mr-3" />Declined</DropdownItem>
                                        <DropdownItem divider/>
                                        <DropdownItem onClick={ () => handleFilter('all_received')} className={switchSent, switchReceived} ><FilterListIcon className="mr-3"/>All Received</DropdownItem>
                 ...
                 <>   
                    <div className='mt-4'>
                        ...
                        <div className="container" style={{border: '2px solid #b11917', height: '80vh', width: '80%', background:'white'}}>
                            {/* <ArrowBackSharpIcon style={{border: '1px solid #b11917', cursor: 'pointer'}} onClick={this.goBack} /> */}
                            <div className="row p-1 pl-md-3 pr-md-3">
                                <button className="btn btn-info col-md-6" onClick={() => switchOrder('received')}><GetAppIcon /> Received Orders</button>
