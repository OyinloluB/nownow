  ...
  return (
    ...
    >
      <div className={styles.modalContent}>
        ...
        <span className={"text-center"} style={{color: '#B11917'}}> As part of our commitment to responsible drinking, please provide your date of birth to confirm you are of legal drinking age (18 years and abovee)</span>
