  ...
  return (
    <>
      <Modal show={show} onHide={closeModal} backdrop="static">
        ...
        <span style={{fontSize: "9", textAlign: "center", fontWeight: 'bold' }}> Contact Email: <span style={{fontWeight: 'bold', color: '#b11917'}}>...@gmail.com</span></span>
        <span style={{fontSize: "9", textAlign: "center", fontWeight: 'bold' }}> Mobile Number: <span style={{fontWeight: 'bold', color: '#b11917'}}>+234...</span></span>
