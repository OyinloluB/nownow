  ...
  return (
    <>
      <Modal show={show} onHide={closeModal} backdrop="static">
        ...
        <address style={{fontSize: "9", textAlign: "center", fontWeight: 'bold' }}> Contact Email: <a style={{fontWeight: 'bold', color: '#b11917', fontSize: '12px'}} href="mailto:IBShopNowSupport@AnheuserBuschInBev.onmicrosoft.com" target="_blank">IBShopNowSupport@...</a></address>
